...
- 增加离线召回评测和真实 LLM A/B：先以 golden metric Recall@K 作为硬门槛，再比较完整 catalog 与 Top-K 的 L1-L4、旧 57 例回归、Prompt 体积/token 和降级率。
...
- `agent-eval`: 增加 golden metric Recall@K、多指标全量召回、完整 catalog/Top-K A/B、Prompt 体积与既有子集回归报告。
