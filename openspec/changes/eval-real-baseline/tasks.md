...
- [x] 5.1 修复 c01 等歧义用例（time_range 定死或标注开放性移出 judged）
- [x] 5.2 报告 L1/L2/L3 带分母展示（如 `87% (13/15)`）

## 6. 文档（P1）

- [x] 6.1 `EVALUATION.md` 更新：正交轴、失败语义三态、评测可用性、语义层评测与 real 评测命令
- [x] 6.2 `README.md` 本地检查命令更新
